        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-blue-600 to-cyan-400 px-6 py-4">
                    ...
                    <p class="text-blue-100 text-sm mt-1">Update the details below to modify the product</p>
                </div>
                ...
                <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ $product->hasImage() ? 'Change Product Image' : 'Product Image' }}
                        </label>
                        <div class="flex items-center space-x-4">
                            <label for="image" class="flex items-center justify-center w-full h-32 px-4 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer hover:border-blue-500 transition @error('image') border-red-500 @enderror">
                                <div class="text-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-600">Click to upload new image</p>
        ...
        function previewImage(event) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    // Optionally hide current image when new one selected
